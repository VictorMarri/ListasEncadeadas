...
namespace AED_SEGUNDA_LISTA
{
    ...
    namespace AED
    {
        ...
        class CLista
        {
            ...
            /// <summary>
            /// Insere um Elemento na posição anterior ao elemento passado por parametro
            /// </summary>
            /// <param name="ElementoAInserir">Elemento que irá ser inserido na lista</param>
            /// <param name="elemento">Elemento passado por parametro que será usado para colocarmos nosso elemento anterior</param>
